...
const Name = styled(Typography)(({ theme }) => ({
  ...
  textShadow: theme.palette.mode === 'dark' ? '0 0 30px rgba(96, 165, 250, 0.5)' : 'none',
  [theme.breakpoints.up('md')]: {
    fontSize: '3.5rem',
  },
}));
          ...
          <IntroSection>
            <Box>
              ...
              <Description>
                ...
                leading distributed teams, and delivering transformative business outcomes 
                across payments, banking, and enterprise solutions.
              </Description>
            </Box>
