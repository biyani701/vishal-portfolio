  ...
  return (
    <div className="auth-container">
      ...
      <div className="providers-grid">
        ...
        <button
          onClick={() => {
            console.log('[client][login] Signing in with Facebook', { callbackUrl });
        ...
        <button
          onClick={() => {
            console.log('[client][login] Signing in with LinkedIn', { callbackUrl });
            signIn('linkedin', { redirectTo: callbackUrl });
          }}
          className="provider-btn"
        ...
        <button
          onClick={() => {
            console.log('[client][login] Signing in with Auth0', { callbackUrl });
            signIn('auth0', { redirectTo: callbackUrl });
          }}
          className="provider-btn"
          data-provider="auth0"
        >
